      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
          {values.map((value, index) => (
            <Card key={index} className="h-full text-center hover:shadow-2xl transition-all duration-500 hover:scale-110 bg-white/90 backdrop-blur-sm border-0 shadow-lg group">
