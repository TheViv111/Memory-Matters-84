          ...
          {[
            ...
            <Card key={index} className="hover:shadow-2xl transition-all duration-500 hover:scale-110 bg-white/90 backdrop-blur-md border-0 shadow-xl group">
              <CardContent className="p-6 text-center">
                ...
                <Link to={item.path}>
                  <button className="w-full font-inter text-sm text-medical-teal hover:text-medical-deep-blue transition-colors duration-200 font-medium bg-gradient-to-r from-medical-teal/10 to-medical-orange/10 px-4 py-2 rounded-lg hover:from-medical-teal/20 hover:to-medical-orange/20">
                    {item.action}
                  </button>
                </Link>
              </CardContent>
