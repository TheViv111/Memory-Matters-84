    ...
    <div className="min-h-screen bg-gradient-to-br from-medical-beige via-white to-medical-teal/5 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10">
        ...
        <div className="flex items-center justify-center space-x-3 mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-medical-teal to-medical-deep-blue rounded-full flex items-center justify-center shadow-2xl animate-pulse">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Neurology & Memory Care</p>
          </div>
        </div>
        ...
        <div className="mt-8 p-4 bg-white/80 backdrop-blur-sm rounded-xl shadow-lg max-w-sm mx-auto">
          ...
          <p className="font-inter text-xs text-gray-600">Board-Certified Neurologist</p>
