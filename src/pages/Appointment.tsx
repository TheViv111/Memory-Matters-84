            ...
            {[
              ...
              <Card 
                ...
                className={`cursor-pointer transition-all duration-200 hover:shadow-lg ${
                  appointmentType === option.type ? 'ring-2 ring-medical-teal bg-medical-teal/5' : ''
                }`}
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="text-center pt-6">
                  <Button 
                    type="submit" 
                    className="bg-medical-deep-blue hover:bg-medical-deep-blue/90 text-white px-12 py-3 text-lg font-inter"
                  >
                    Request Appointment
                  </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-inter font-semibold text-medical-charcoal mb-2">Call Us</h3>
                <p className="font-inter text-medical-deep-blue font-medium">(555) 123-4567</p>
                <p className="font-inter text-sm text-gray-600 mt-1">Mon-Fri: 8AM-5PM</p>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6 text-center">
                <Video className="w-8 h-8 text-medical-teal mx-auto mb-4" />
                <h3 className="font-inter font-semibold text-medical-charcoal mb-2">Video Consult</h3>
                <p className="font-inter text-gray-600">Available for follow-ups</p>
                <p className="font-inter text-sm text-gray-600 mt-1">Same day available</p>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6 text-center">
                <Clock className="w-8 h-8 text-medical-teal mx-auto mb-4" />
                <h3 className="font-inter font-semibold text-medical-charcoal mb-2">Emergency</h3>
                <p className="font-inter text-medical-deep-blue font-medium">24/7 Line</p>
                <p className="font-inter text-sm text-gray-600 mt-1">For existing patients</p>
              </CardContent>
            </Card>
          </div>
        </div>
